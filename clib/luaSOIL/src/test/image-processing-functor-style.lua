...
make_img_funcs=function(img_path,width,height,req_channels)
	...
	local row=width*req_channels
	local get,set,save
	local color={}
	get=function(x,y)
		local pos=row*y+x*req_channels
...
local get,set,save,w,h,ch,rch=make_img_funcs("/host/Files/lua-platform/data/water.jpeg",nil,nil,3)
