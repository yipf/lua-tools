...
create_imgmat=function(width,height,channels,req_channels)
	width,height,channels,req_channels=width or 1,height or 1,soil.LOAD_RBG,soil.LOAD_RBG
	local img=soil.create_img(width,height,req_channels)
	if not img then 
...
local img2mat=function(filepath,req_channels)
	req_channels=req
	local mat={}
end

local mat2img=function(mat,filepath)
